...
<body>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input class="form-control"  type="text " id="" placeholder="Tìm Kiếm" size="20" name="nhap" value=""> 
        </div>
        <div class="col-sm-2">
        <button type="submit"  class="btn btn-danger ml-1" name="search"><i class="fas fa-search"></i> Tiềm Kiếm</button>
        </div>
        <div class="col-sm-1">
        <button type="reset"  class="btn btn-danger " name="">
            <a href="ql_user.php" style="text-decoration: none; color:white">Hủy <i class="far fa-window-close"></i></a></button>
        </div>
        ...
        <div>
               ...
               <?php
                   ...
                   { echo "<tr>";
                       ...
                       echo "<td><a href='register.php'><button class='btn btn-info'>Thêm</button></a></td>";
                       echo "</tr>";
                   $stt+=1;
                   }//while
                   }
